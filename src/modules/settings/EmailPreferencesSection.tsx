  ...
  return (
    <div className="space-y-3">
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.875rem' }}>
        <Mail style={{ width: '1rem', height: '1rem', color: 'var(--wis-blue)', flexShrink: 0 }} />
        <div style={{ flex: 1, minWidth: 0 }}>
          <p style={{ fontSize: '0.875rem', color: 'var(--wis-text)', margin: 0, fontWeight: 500 }}>
        ...
        <button
          ...
          style={{
            ...
            border: '1px solid var(--wis-border-strong)', cursor: 'pointer', padding: 0,
            background: enabled ? '#1A6B5A' : 'var(--wis-surface-4)',
        ...
        >
          <span style={{
            ...
            width: '1.1rem', height: '1.1rem', borderRadius: '9999px', background: 'var(--wis-surface)',
            transition: 'left 0.15s',
          }} />
        </button>
      </div>

      <p style={{ fontSize: '0.72rem', color: 'var(--wis-text-3)', lineHeight: 1.6, margin: 0 }}>
