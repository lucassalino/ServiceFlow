...
/**
 * Ecrã forçado quando a org fica `downgraded_locked` (cancelou a assinatura
 * e ficou acima dos limites do Semente). O admin escolhe até 1 ministério e
 * 10 pessoas para se manterem operacionais — nada é apagado, o resto fica
 * só de leitura.
 */
